...
import './Product.css'
const Products = ({componentRef}) => {
  return (
    
        <div ref={componentRef} className={`flex flex-col items-center pb-48`}>
            ...
            <div className="sm:flex justify-between items-center gap-40 sm:space-y-0 space-y-20 mt-10">
                {
                    ProductArray.map((item, index)=> {
                        ...
                        return(
                            <div key={index} className="w-[331px] h-[417px] sm:border-none p-5 rounded-[4px] bg-white flex flex-col justify-center gap-5 border border-secondary">

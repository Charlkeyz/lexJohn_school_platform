...
const ServicePage = () => {
  ...
  useEffect(() => {
    AOS.init({
      ...
      once: true,
      offset: 100,     // Whether animation should happen only once - while scrolling down
    });
  }, []);
        ...
        <section className="flex flex-col justify-center items-center w-screen">
          <div className="flex flex-col sm:flex-row sm:w-[1065px]  w-screen h-fit sm:h-fit justify-center items-center mt-20">
            <div className="flex flex-col justify-center items-center sm:items-start sm:gap-10 gap-5 p-2">
              <h1 className="text-[40px] font-bold leading-[48px]" data-aos="fade-down">What we do</h1>
            ...
            <img data-aos="fade-left" data-aos-delay="200" data-aos-duration="1000" src={ServiceImg} alt="" />
          </div>
            ...
            <div className="flex flex-col justify-center gap-10 mt-10">
              <div className="flex flex-col justify-center items-center">
                ...
                <p data-aos="fade-left" data-aos-delay="100" className="sm:text-base text-sm text-text-color p-2 sm:p-0 font-normal leading-6 sm:w-[1115px] w-screen text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit.
